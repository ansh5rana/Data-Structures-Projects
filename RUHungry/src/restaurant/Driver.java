    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                // Menu
                    StdOut.print("Great! Enter the menu input file [there's only one ;) ] => ");
                ...
                // Transactions
                    ...
                    if (yesORno.equalsIgnoreCase("Y")) {
                        ...
                        switch (secondChoice) {
                            case 1:
                                StdOut.print("Great! Enter an order input file => ");
                                String orderInputFile = StdIn.readLine();

                                testIndividualMethods(orderInputFile, "order", restaurant);
                                break;
                            case 2:
                                StdOut.print("Great! Enter a donation input file => ");
                            ...
                            case 3:
                                ...
                                break;
                            default:
                                StdOut.print("That isn't a valid option but no worries, try again!");
                        }
                    }
                        ...
                        StdOut.println("That isn't a valid option but no worries, try again!");
                    }
                    break;
                case 6:
                // Quit
